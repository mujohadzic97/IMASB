...
public final class LoginServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.example.hello.LoginRequest,
      com.example.hello.LoginResponse> getLoginMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "login",
      requestType = com.example.hello.LoginRequest.class,
      responseType = com.example.hello.LoginResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.example.hello.LoginRequest,
      com.example.hello.LoginResponse> getLoginMethod() {
    io.grpc.MethodDescriptor<com.example.hello.LoginRequest, com.example.hello.LoginResponse> getLoginMethod;
      ...
      synchronized (LoginServiceGrpc.class) {
        if ((getLoginMethod = LoginServiceGrpc.getLoginMethod) == null) {
          LoginServiceGrpc.getLoginMethod = getLoginMethod =
              io.grpc.MethodDescriptor.<com.example.hello.LoginRequest, com.example.hello.LoginResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "login"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.hello.LoginRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.example.hello.LoginResponse.getDefaultInstance()))
  ...
  public static abstract class LoginServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void login(com.example.hello.LoginRequest request,
        io.grpc.stub.StreamObserver<com.example.hello.LoginResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.example.hello.LoginRequest,
                com.example.hello.LoginResponse>(
                  this, METHODID_LOGIN)))
          .build();
    }
  }
  ...
  public static final class LoginServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<LoginServiceBlockingStub> {
    ...
    /**
     */
    public com.example.hello.LoginResponse login(com.example.hello.LoginRequest request) {
  ...
  public static final class LoginServiceFutureStub extends io.grpc.stub.AbstractFutureStub<LoginServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.hello.LoginResponse> login(
        com.example.hello.LoginRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LOGIN:
          serviceImpl.login((com.example.hello.LoginRequest) request,
              (io.grpc.stub.StreamObserver<com.example.hello.LoginResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class LoginServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.hello.Helloservice.getDescriptor();
    }
